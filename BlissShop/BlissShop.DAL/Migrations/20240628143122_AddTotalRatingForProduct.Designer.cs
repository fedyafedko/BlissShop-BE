...
namespace BlissShop.DAL.Migrations
{
    ...
    [Migration("20240628143122_AddTotalRatingForProduct")]
    partial class AddTotalRatingForProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlissShop.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlissShop.Entities.Setting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlissShop.Entities.Product", b =>
                {
                    b.HasOne("BlissShop.Entities.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("BlissShop.Entities.Setting", b =>
                {
                    b.HasOne("BlissShop.Entities.User", "User")
                        .WithOne("Setting")
                        .HasForeignKey("BlissShop.Entities.Setting", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
